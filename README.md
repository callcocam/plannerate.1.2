...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/plannerate.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/plannerate)
...
```php
$plannerate = new Callcocam\Plannerate();
echo $plannerate->echoPhrase('Hello, Callcocam!');
```
