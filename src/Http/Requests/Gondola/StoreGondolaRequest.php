...
class StoreGondolaRequest extends BaseFormRequest
{
    public function rules(): array
    {
        return [
            ...
            'slug' => ['nullable', 'string', 'max:255', 'unique:gondolas,slug'],
            ...
            'section.name' => ['required_with:section', 'string', 'max:255'],
            'section.width' => ['required_with:section', 'numeric', 'min:1'],
            'section.height' => ['required_with:section', 'numeric', 'min:1'],
